...
public class MavenPackageImpl extends EPackageImpl implements MavenPackage {
	...
	public void initializePackageContents() {
		...
		projectEClass.getESuperTypes().add(this.getCoordinates());
		...
		initEReference(getProject_Modules(), this.getProject(), null, "modules", null, 0, -1, Project.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
