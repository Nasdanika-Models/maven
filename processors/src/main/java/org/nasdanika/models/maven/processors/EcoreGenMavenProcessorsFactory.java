package org.nasdanika.models.maven.processors;
...
@EPackageNodeProcessorFactory(nsURI = MavenPackage.eNS_URI)
public class EcoreGenMavenProcessorsFactory {
...
//	public final AccessLevelProcessorsFactory accessLevelFactory;
	...
	public EcoreGenMavenProcessorsFactory(Context context) {
